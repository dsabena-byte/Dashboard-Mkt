#!/usr/bin/env node
/**
 * Render del video Tu mercado: Chromium avanza la animación frame a frame (window.__seek)
 * y cada captura se pipea a ffmpeg. Determinístico: no depende del reloj real.
 *
 *   node render.mjs                      -> export/mercado.mp4
...
const mp4 = resolve(OUT, 'mercado.mp4');
