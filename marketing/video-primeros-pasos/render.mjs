#!/usr/bin/env node
/**
 * Render del video Primeros pasos: Chromium avanza la animación frame a frame (window.__seek)
 * y cada captura se pipea a ffmpeg. Determinístico: no depende del reloj real.
 *
 *   node render.mjs                      -> export/primeros-pasos.mp4 (1920x1080 @30fps, 50 s)
...
const mp4 = resolve(OUT, 'primeros-pasos.mp4');
