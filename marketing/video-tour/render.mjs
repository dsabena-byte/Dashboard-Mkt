 ...
 *
 *   node render.mjs                      -> export/tour-plataforma.mp4 (1920x1080 @30fps, 64 s)
 *   node render.mjs --fps 30 --scale 1   -> opciones
 *   node render.mjs --stills 9,17,26,34  -> PNGs sueltos en export/stills (revisión)
 */
...
const mp4 = resolve(OUT, 'tour-plataforma.mp4');
