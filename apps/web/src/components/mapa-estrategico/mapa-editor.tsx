...
export function MapaEditor() {
  ...
  return (
    <div className="mapa-cal">
      ...
      <div className="grid gap-5 lg:grid-cols-[minmax(0,470px)_minmax(0,1fr)]">
        ...
        <div className="lg:sticky lg:top-4 lg:self-start">
          <div className="rounded-2xl border bg-card p-4 shadow-sm">
            ...
            <svg viewBox={`0 0 640 ${svg.viewH}`} role="img" aria-label="Mapa de contribución Plan a KPI a Objetivo" className="block h-auto w-full" dangerouslySetInnerHTML={{ __html: svg.inner }} />
          </div>
