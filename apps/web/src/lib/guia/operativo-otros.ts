...
- **Vínculo con Search Console** para ver consultas orgánicas en GA4.`,
    ...
    relacionados: ["utm-nomenclatura", "web-cro", "meta-pixel-capi", "conectar-fuentes", "search-console"],
  },
  {
    id: "utm-nomenclatura",
...
Al guardar, las cards del tablero (Mes y Acumulado YTD) y el Seguimiento Objetivos se actualizan con la meta nueva.`,
    ...
    relacionados: ["ciclo-construir", "mapa-estrategico", "metas-mensuales", "ga4-configuracion", "tableros-planilla"],
  },
  {
    id: "mapa-estrategico",
...
Cuando termines, el siguiente paso es revisar las metas de cada KPI en su tablero.`,
    ...
    relacionados: ["modelo-objetivos-kpis", "objetivos-negocio-marketing", "conectar-fuentes", "proceso-estrategico"],
  },
  {
    id: "insights-chat",
...
Evitá preguntas vagas ("¿cómo vamos?"): pedí comparación, período y métrica.`,
    ...
    relacionados: ["plan-de-accion", "ciclo-aprender", "reporte-mensual", "proceso-estrategico"],
  },
  {
    id: "tableros-planilla",
...
- **Tiendas relevadas:** el cumplimiento de CB se lee sobre las tiendas medidas en el período (baseline de las últimas semanas), no sobre el universo.`,
    ...
    relacionados: ["presupuesto-marketing", "trade-marketing", "conectar-fuentes", "ciclo-acelerar"],
  },
];
