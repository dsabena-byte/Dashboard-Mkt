...
// del menú hasta que la página destino monta en el cliente. Captura TODO lo vivido
// (cold start de Vercel + queries + render RSC + red + hidratación).
...
// Devuelve los ms transcurridos si el último clic apuntaba a matchHref; consume la marca.
