...
export const BRAND_LOOK =
  ...
  "LIGHT: warm, inviting, WELL-LIT lighting with a GENEROUS soft ambient/fill — clearly raise the overall exposure so the image reads BRIGHT, warm and inviting at a glance (a bright premium look, not a dark one). Warm and premium with only gentle moody accents in the corners, but the scene overall is NOT dark, dim, gloomy, murky, underexposed, black or crushed — the whole environment (walls, cabinetry, background) is clearly visible and legible. The main subject and the appliance are brightly and cleanly lit with full detail. Amber/tungsten temperature, cinematic and premium. " +
