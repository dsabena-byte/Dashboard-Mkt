...
export const PROCS: Proc[] = [
  ...
  { id: "seo_serp", proceso: "SEO · Posición (SERP matrix)", fuente: "DataForSEO", conexion: "GitHub Action", detalle: "/api/cron/seo-sync · mensual", cadenciaH: 720, tabla: "seo_rankings", col: "fetched_at", workflow: "seo-sync.yml" },
