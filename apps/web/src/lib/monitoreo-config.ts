...
export const PROCS: Proc[] = [
  { id: "ga4", proceso: "Tráfico Web (GA4)", fuente: "Google Analytics 4", conexion: "GitHub Action", detalle: "/api/cron/ga4-web-traffic · cada 6h", cadenciaH: 6, tabla: "web_traffic", col: "updated_at", workflow: "ga4-sync.yml" },
  ...
  { id: "seo_demanda", proceso: "SEO · Demanda & Share of Search", fuente: "DataForSEO", conexion: "GitHub Action", detalle: "/api/cron/trends-sync · semanal", cadenciaH: 168, tabla: "search_volume", col: "fetched_at", workflow: "trends-sync.yml" },
  { id: "seo_trends", proceso: "SEO · Interés (Google Trends)", fuente: "DataForSEO", conexion: "GitHub Action", detalle: "/api/cron/trends-sync · semanal", cadenciaH: 168, tabla: "trends_interest", col: "fetched_at", workflow: "trends-sync.yml" },
  { id: "seo_serp", proceso: "SEO · Posición (SERP matrix)", fuente: "DataForSEO", conexion: "GitHub Action", detalle: "/api/cron/seo-sync · semanal", cadenciaH: 168, tabla: "seo_rankings", col: "fetched_at", workflow: "seo-sync.yml" },
  { id: "seo_indice", proceso: "SEO · Índice de posición (histórico)", fuente: "Cálculo interno (SERP)", conexion: "GitHub Action", detalle: "/api/cron/seo-index-snapshot · con seo-sync", cadenciaH: 168, tabla: "seo_index_history", col: "updated_at", workflow: "seo-sync.yml", nota: "Snapshot mensual del índice; lo dispara el workflow de seo-sync al terminar." },
