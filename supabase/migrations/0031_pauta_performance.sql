...
create table if not exists pauta_performance (
  ...
  objetivo         text not null,                  -- Build | Consider | Build & Consider
...
comment on column pauta_performance.objetivo is 'Build = Upper Funnel (Awareness) | Consider = Mid Funnel | Build & Consider = video (cuenta como Upper para no doblar inversión).';
...
values
  ...
  ('Abril 2026', 'Brand', 'YouTube', 'Build & Consider', 'CPV', 1142857, 1550013, 1.5, 1.29, 1714286, 1992900, 3000, 2619, 1200000, 1306329, 3000000, 2958346.79, 2.5, 2.26, 0.15, 0.13),
  ...
  ('Abril 2026', 'Cocción', 'YouTube', 'Build & Consider', 'CPV', 1436459, 1140014, 1.5, 1.4, 2154688, 1598740, 3232, null, 1508282, 1096756, 3770704.08, 2012787.63, 2.5, 1.84, 0.15, 0),
  ...
  ('Abril 2026', 'Lavado', 'YouTube', 'Build & Consider', 'CPV', 2671398, 2734476, 1.5, 1.97, 4007097, 5389939, 6011, 5298, 2804968, 3717310, 7012420, 7012771, 2.5, 1.89, 0.15, 0.1),
  ...
  ('Abril 2026', 'Refrigeración', 'YouTube', 'Build & Consider', 'CPV', 2154688, 1269795, 1.5, 1.72, 3232032, 2185462, 4848, 2581, 2262422, 1459815, 5656056.12, 3019183, 2.5, 2.07, 0.15, 0.12),
  ...
  ('Abril 2026', 'Promoción', 'YouTube', 'Build & Consider', 'CPV', 227665, 2356784, 15, 1.32, 3414977, 3120543, 5122, 1341, 2390484, 2964102, 5976210.24, 4179364, 2.5, 1.41, 0.15, 0.04),
  ...
  ('Mayo 2026', 'Brand', 'YouTube', 'Build & Consider', 'CPV', 2381048, 1550013, 1.5, 1.29, 3571572, 1992900, 5357, 2619, 2500100, 1306329, 6250250.5, 5585056, 2.5, 4.28, 0.15, 0.13),
  ...
  ('Mayo 2026', 'Cocción', 'YouTube', 'Build & Consider', 'CPV', 2326231, 1651054, 1.5, 1.47, 3489347, 2428169, 5234, 3316, 2442543, 1605679, 6106356.68, 3511582, 2.5, 2.19, 0.15, 0.14),
  ...
  ('Mayo 2026', 'Lavado', 'YouTube', 'Build & Consider', 'CPV', 6256674, 2740254, 1.5, 1.99, 9385011, 5440044, 14078, 6338, 6569507, 3706727, 16423768.72, 7385446, 2.5, 1.99, 0.15, 0.12),
  ...
  ('Mayo 2026', 'Refrigeración', 'YouTube', 'Build & Consider', 'CPV', 2154688, 1929320, 1.5, 2.01, 3232032, 3883986, 4848, 4551, 2262422, 2611930, 10468412.01, 5846221, 2.5, 2.24, 0.15, 0.12),
